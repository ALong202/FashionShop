...
const Footer = () => {
  ...
  <h4 className="footer-logo"><a title="FashionShop" href="https://FashionShop.vn/"> <img src="../images/FashionShop_logo.svg" alt="" className=""/></a></h4>
  ...
  <li className="zalo"><a title="FashionShop" href="https://oa.zalo.me/FashionShop?src=">&nbsp;</a></li>
  </ul>
